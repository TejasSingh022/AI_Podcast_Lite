...
function PromptInput() {
    ...
    const generatePodcast = async (topic) => {
        try {
            setLoaded(true);
            const response = await axios.post(`http://localhost:5000/api/podcasts/generate-script/${topic}`);
    ...
    return (
        <div className="flex justify-center items-center pt-20 p-4 max-w-full">
            <div className='flex flex-col items-center'>
                ...
                <button 
                    type='submit'
                    onClick={()=>generatePodcast(prompt)}
                ...
                <div>
                    ...
                    <div className='rounded-md border border-gray-200 w-full max-w-4xl m-8'>
                        ...
                        <div className='flex flex-col items-center'>
                            <div className='flex'>
                                <div className='text-2xl font-medium mt-4 pt-1'>Title: </div>
                                <textarea 
                            ...
                            <div className='w-[90%] bg-zinc-900 text-white rounded-md m-8 p-5 whitespace-pre-wrap'>
                                {script}
                            </div>
